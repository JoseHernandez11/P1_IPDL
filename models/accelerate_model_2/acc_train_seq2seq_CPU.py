...
from torch.profiler import profile, ProfilerActivity  # Profiler de PyTorch
...
# Clase para manejar el vocabulario
class Lang:
...
# Función principal de entrenamiento con profiler de PyTorch
def train(train_dataloader, encoder, decoder, n_epochs, learning_rate=0.001,
    ...
    # Usar el profiler de PyTorch
    with profile(
        activities=[ProfilerActivity.CPU],  # Perfilamos solo la CPU (puedes agregar CUDA si usas GPU)
        record_shapes=True  # Registrar formas de tensores para análisis detallado
    ) as prof:
...
hidden_size = 128
batch_size = 32
epochs = 2  # Puedes aumentar este valor según tus necesidades
